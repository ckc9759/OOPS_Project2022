...
public class Solution1{
    ...
    public static void main(String[] args) {
        ...
        if(str.equals("S")){
            ...
            System.out.println("Enter trip ID after pressing enter key if options C/A/R are chosen");
            ...
            switch(option){
                    ...
                    case "T":
                            ...
                            System.out.println("<Date(dd-mm-yy)> <Source> <Destination> <Time of Departure(add PM/AM without space)>");
